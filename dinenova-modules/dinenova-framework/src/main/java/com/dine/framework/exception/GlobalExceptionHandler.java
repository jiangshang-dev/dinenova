package com.dine.framework.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseObject handleRuntimeServiceException(ServiceException e) {
        log.error(e.getMessage(), e);
        return new ResponseObject(e.getCode(), e.getMessage(), e.getData());
    }
