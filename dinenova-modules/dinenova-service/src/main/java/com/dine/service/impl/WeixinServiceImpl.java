...
import com.dine.bean.H5SceneInfo;
import com.dine.bean.WxPayBean;
import com.dine.dto.OrderDto;
import com.dine.dto.UserOrderDto;
import com.dine.dto.WxCardDto;
import com.dine.enums.*;
import com.dine.http.HttpRESTDataClient;
import com.dine.service.*;
import com.dine.util.*;
...
import com.dine.utils.QRCodeUtil;
...
public class WeixinServiceImpl implements WeixinService {
    ...
    public Map<String, String> processResXml(HttpServletRequest request) {
        try {
            String xmlMsg = new String(request.getInputStream().readAllBytes(), java.nio.charset.StandardCharsets.UTF_8);
        ...
        try {
            ...
            if (data.get("errcode").toString().equals("0")) {
                ...
                try {
                    ...
                    com.dine.util.QRCodeUtil.createQrCode(out, content, 800, 800, "png", "");
                    // 对数据进行Base64编码
